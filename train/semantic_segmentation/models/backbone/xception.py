...
class AlignedXception(nn.Module):
    ...
    def __init__(self, in_channels, output_stride, BatchNorm, pretrained=True):
        ...
        if output_stride == 16 or output_stride == 32:
        ...
        stride_conv2 = 2 if output_stride == 32 else 1
        ...
        self.conv2 = nn.Conv2d(32, 64, 3, stride=stride_conv2, padding=1, bias=False)
    ...
    def forward(self, x):
        ...
        x = self.relu(x)
        # print(x.shape)
        # print([i.shape for i in jpu],x.shape)
        # import sys
        # sys.exit()
        return x, [low_level_feat, jpu]
